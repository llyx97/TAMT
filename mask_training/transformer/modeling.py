...
class BertAttention(nn.Module):
    ...
    def forward(self, input_tensor, attention_mask, head_mask):
        self_output, layer_att = self.self(input_tensor, attention_mask, head_mask=head_mask)
...
class RobertaForPreTraining(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None,
                attention_mask=None, masked_lm_labels=None,
                next_sentence_label=None, labels=None, head_mask=None, ffn_mask=None):

        sequence_output, att_output, pooled_output = self.roberta(
            input_ids, token_type_ids, attention_mask, head_mask=head_mask, ffn_mask=ffn_mask)
...
class TinyBertForSequenceClassification(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None,
                labels=None, is_student=False, head_mask=None, ffn_mask=None):

        sequence_output, att_output, pooled_output = self.bert(input_ids, token_type_ids, attention_mask,
                                                               output_all_encoded_layers=True, output_att=True, head_mask=head_mask, ffn_mask=ffn_mask)
