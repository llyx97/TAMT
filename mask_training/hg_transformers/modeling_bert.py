...
class BertLayer(nn.Module):
    ...
    def forward(
        ...
        intermediate_output = self.intermediate(attention_output, ffn_mask) if self.intermediate is not None else attention_output
        layer_output = self.output(intermediate_output, attention_output) if self.output is not None else intermediate_output
