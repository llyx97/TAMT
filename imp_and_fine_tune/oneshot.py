...
parser.add_argument('--root_dir', default='', type=str, help='root dir')
...
if args.model == 'glue':
    ...
    output_mask_dir = os.path.join(args.root_dir, output, args.prun_type, str(args.rate), str(args.seed))
