	...
	do
	{
		python $root_dir/imp_and_fine_tune/glue_trans.py \
		       --dir pre \
                       ...
                       --output_dir $root_dir/imp_and_fine_tune/log/glue/$prun_type/wikitext-103/$model_type/length$block_size/$task/$zero_rate/seed$mask_seed/$seed \
		       --logging_steps 500 \
		       --task_name $task \
