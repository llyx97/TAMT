...
do
	...
	python $root_dir/imp_and_fine_tune/squad_trans.py \
		   --dir pre \
		   --mask_dir $root_dir/mask_training/models/prun_bert/unstructured/$prun_type/wikitext-103/length128/$zero_rate/seed$mask_seed/checkpoint-$step/mask.pt \
		   --output_dir $root_dir/imp_and_fine_tune/log/squad/$prun_type/wikitext-103/steps/step$step/$zero_rate/seed$mask_seed/$seed \
		   --model_type bert \
